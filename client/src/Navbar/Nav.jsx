      ...
      <nav className="bg-gradient-to-r from-indigo-600 to-blue-800 p-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            <button
              onClick={toggleLogin}
              className="bg-white text-blue-600 px-6 py-2 rounded uppercase"
            >
              Login
            </button>
          </div>
        ...
        >
          ...
          <NavLink
            to="/find-jobs"
            className="block text-white px-4 py-2 uppercase"
          >
            Find Jobs
          </NavLink>
          <NavLink
          ...
          <button
            onClick={toggleLogin}
            className="block bg-white text-blue-600 px-6 py-2 rounded mx-4 my-2 uppercase"
          >
            Login
          </button>
        </div>
